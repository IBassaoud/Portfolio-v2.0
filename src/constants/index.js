...
const experiences = [
  {
    ...
    points: [
      "Development and maintenance of the RAO application.",
      "Implementation of transcription functionality using WHISPER AI.",
      "Design and development of an interactive user interface for the transcription tool.",
      "Creation of a service (backend) to manage transcription tool operations.",
    ],
  },
  {
...
const testimonials = [
  {
    testimonial:
      "Après quelques mois passés avec Ismail, je peux vous assurer qu'il sait parfaitement prendre en charge un projet et le developper avec beaucoup d'autonomie, toujours prêt à fournir des efforts pour acquerir ou optimiser le code, un très bon élément à intégrer dans une équipe !",
    name: "Pierre Husson",
  ...
  {
    testimonial:
      "Ismail a su travailler en grande autonomie dans notre entreprise, malgré le fait d'être totalement en distanciel. Il a vite compris l'architecture du projet et su se rendre efficace en peu de temps. Il a fait preuve d'un grand professionnalisme et motivation.",
    name: "Martin R.",
  ...
  {
    testimonial:
      "Ismail has been a valuable asset to our team in his time in InQompass as a Junior Full Stack Developer. He demonstrated keen learning, great teamwork, and strong technical skills, especially on Angular and Css. Clearly one of the most promising junior talent I had the chance to work with.",
    name: "Teddy DEFREL",
...
const projects = [
  ...
  {
    name: "Tour of Heroes",
    description: `The "Tour of Heroes" is a step-by-step guide designed to introduce developers to Angular by building a "Heroes" application. The application displays a list of heroes, allowing users to select a hero, view the hero's details, and edit the hero's name.`,
    tags: [
      {
        name: "Angular",
        color: "red-text-gradient",
